...
- На сколько верст расстояние между пароходами увеличивается каждый час?
- На каком расстоянии от города В будет второй пароход в то самое время, когда первый прибудет в этот город?
- Во сколько часов со времени отправления из А расстояние между пароходами возросло до вышенайденной величины?
...
2091. Из города послан курьер, проезжающий в каждые 5 часов по 9 миль; через "https://render.githubusercontent.com/render/math?math=$4\frac{1}{2}$"> часа после его отЪезда послан вслед за ним другой курьер, который в каждые 5/9 часа делает по <img src="https://render.githubusercontent.com/render/math?math=$1\frac{1}{2}$"> мили. Через сколько времени второй курьер догонит первого?
